  ...
  return (
    <div className="py-6 border-b border-border">
      <div className="flex items-center justify-between mb-6">
        <h3 className="font-bold text-lg text-foreground">Your Network</h3>
        <button onClick={onOpenSidebar} className="text-xs font-semibold text-primary hover:underline">See all activity →</button>
      </div>
          ...
          <div key={i} className="flex gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="font-bold text-sm text-foreground">{act.user}</span>
      ...
      <div className="mt-6 text-center">
        ...
        <button className="text-xs font-semibold text-primary hover:underline">Find friends or join a club →</button>
      </div>
    </div>
  );
}
