    ...
    <div className="p-6 bg-background shrink-0">
      <div className="relative max-w-4xl mx-auto flex items-end">
        ...
        <textarea 
          ...
          className="w-full bg-surface border border-border rounded-2xl pl-14 pr-16 py-3.5 text-foreground text-sm outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary/50 placeholder:text-text-muted transition-all shadow-inner resize-none overflow-hidden min-h-[50px] leading-relaxed"
        />
